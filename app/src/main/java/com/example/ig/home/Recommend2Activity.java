...
public class Recommend2Activity extends FragmentActivity {
    private Button backButton;
    private TextView textView;
    private WebView webView;
    private String mstrLoginUrl = "file:///android_asset/recommend2.html";

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.home_recommend2);
        // 设置nav标题
