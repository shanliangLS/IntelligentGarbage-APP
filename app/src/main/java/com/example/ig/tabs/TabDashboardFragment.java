...
import com.example.ig.dashboard.DashboardGoodsEat;
import com.example.ig.dashboard.DashboardGoodsHat;
import com.example.ig.dashboard.DashboardGoodsMan;
import com.example.ig.dashboard.DashboardGoodsTotal;
import com.example.ig.dashboard.DashboardGoodsWoman;
...
public class TabDashboardFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        buttonArrayList.set(0,(Button) view.findViewById(R.id.dashboard_goods_type_total));
        ...
        buttonArrayList.set(3,(Button) view.findViewById(R.id.dashboard_goods_type_eat));
        buttonArrayList.set(4,(Button) view.findViewById(R.id.dashboard_goods_type_hat));

        buttonLineArrayList.set(0,(Button) view.findViewById(R.id.dashboard_goods_type_line1));
        ...
        buttonLineArrayList.set(3,(Button) view.findViewById(R.id.dashboard_goods_type_line4));
        buttonLineArrayList.set(4,(Button) view.findViewById(R.id.dashboard_goods_type_line5));

        buttonLineGrayArrayList.set(0,(Button) view.findViewById(R.id.dashboard_goods_type_line_gray1));
        ...
        buttonLineGrayArrayList.set(3,(Button) view.findViewById(R.id.dashboard_goods_type_line_gray4));
        buttonLineGrayArrayList.set(4,(Button) view.findViewById(R.id.dashboard_goods_type_line_gray5));
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mFragments.add(new DashboardGoodsTotal());
        mFragments.add(new DashboardGoodsMan());
        mFragments.add(new DashboardGoodsWoman());
        mFragments.add(new DashboardGoodsEat());
            ...
            buttonArrayList.get(i).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    for (int j = 0; j < mFragments.size(); j++) {
                        if (buttonArrayList.get(j).equals(this)) {
